...
<section class="food_section layout_padding-bottom">
    <div class="container">
      ...
      <div class="filters-content" id="filters">
        <div class="row grid " style="position: relative; height: 1398px;">
            @foreach ($categories as $item)
          <div class="col-sm-6 col-lg-4 all {{$item->id}}" style="position: absolute; left: 0px; top: 0px;">
            <div class="box">
              <div>
                <div class="img-box">
                ...
                <div class="detail-box">
                  ...
                  <div>
                    <a href="{{route('all.product' , $item->id)}}"  class="btn btn-warning">Brows</a>
                        <g>
                          <g>
                            <path d="M345.6,338.862c-29.184,0-53.248,23.552-53.248,53.248c0,29.184,23.552,53.248,53.248,53.248
        ...
        <div class="owl-carousel client_owl-carousel">
          ...
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{$item->imagepath}}" alt="" class="box-img">
              </div>
            </div>
          </div>
          @endforeach
